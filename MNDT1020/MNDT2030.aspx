<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Async="true" AutoEventWireup="true" CodeFile="MNDT2030.aspx.cs" Inherits="MNDT2030" %>
...
<asp:Content runat="server" ID="const" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <ContentTemplate>
            <asp:MultiView runat="server" ID="multi_view" ActiveViewIndex="0">
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                ...
                                <cc1:GGridView runat="server" EmptyShowHeader="True" EmptyDataText="無顯示資料" OnRowDataBound="grid_data_m_RowDataBound" OnRowCommand="grid_data_m_RowCommand"
                                    ...
                                    ID="grid_data_m" DataSourceID="sds_main" DataKeyNames="product_kind">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="新增">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="ibtn_delete" CommandName="Delete" runat="server" ImageUrl="~/Image/delete.png" onmouseover="this.src='/Image/delete_1.png'" onmouseout="this.src='/Image/delete.png'" OnClientClick="return(confirm('確認要刪除主檔+明細嗎？'))"></asp:ImageButton>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="描述">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_product_description" runat="server" Text='<%#Bind("product_description") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="10%" />
                                            <ItemStyle Width="10%" />
                                        </asp:TemplateField>
                ...
                <asp:View runat="server" ID="view_detail">
                    ...
                    <asp:FormView runat="server" ID="fv_master_form" CssClass="max-width" DefaultMode="Edit" DataSourceID="sds_main" DataKeyNames="product_kind" OnItemCommand="form_view_master_ItemCommand">
                        <InsertItemTemplate>
                            <table class="max-width">
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_kind" Text='<%#Bind("product_kind") %>'></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="父代碼名稱："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_kind_name" Text='<%#Bind("product_kind_name") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="right">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_description" Text='<%#Bind("product_description") %>' Width="90%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="備註："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_remarks" Text='<%#Bind("product_remarks") %>' Width="90%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                </tr>
                        ...
                        <EditItemTemplate>
                            <table class="max-width">
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_kind" Text='<%#Bind("product_kind") %>' CssClass="gray-style2" ReadOnly="true"></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="父代碼名稱："></asp:Label>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_description" Text='<%#Bind("product_description") %>' Width="100%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="備註："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_product_remarks" Text='<%#Bind("product_remarks") %>' Width="100%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td colspan="8" class="center">
                                        ...
                                        <asp:Button runat="server" CssClass="blue-style6 button-size2" Text="刪除" CommandName="Delete" OnClientClick="return(confirm('確認要刪除主檔和明細嗎？'))" />
                                        <asp:Button runat="server" CssClass="blue-style6 button-size2" Text="取消" CommandName="Cancel" ID="btn_master_cancel" />
                                    </td>
    ...
    <asp:SqlDataSource ID="sds_main" OnUpdated="sds_main_Updated" runat="server" ConnectionString="<%$ ConnectionStrings:MNDT %>" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:MNDT.ProviderName %>" UpdateCommand="UPDATE [MNDTproduct_master]
   SET [product_kind_name] = @product_kind_name
...
WHERE product_kind = @original_product_kind"
        InsertCommand="INSERT INTO [MNDTproduct_master]
([product_kind]
	,[product_kind_name]
	,[product_description]
	,[product_remarks]
...
VALUES(@product_kind
	...
	,GETDATE())"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="product_kind_name" />
