<%@ Page Language="C#" Async="true" MasterPageFile="~/MasterPage.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="MNDT4020.aspx.cs" Inherits="MNDT4020" %>
...
<asp:Content runat="server" ID="const" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:UpdatePanel runat="server" UpdateMode="Conditional">
                ...
                <asp:View runat="server" ID="view_master">
                    <table class="blue-style2 table-size1">
                        ...
                        <tr>
                            ...
                            <td class="right">
                                <asp:Label runat="server" Text="出貨日期：" CssClass="font-style1"></asp:Label>
                            </td>
                            <td class="left">
                        ...
                        <tr>
                            ...
                            <td class="left">
                                <asp:DropDownList ID="drop_sales_complete" runat="server" CssClass="dropdwonlist-size2">
                                    <asp:ListItem Value="0">出貨中</asp:ListItem>
                                    <asp:ListItem Value="1">已出貨</asp:ListItem>
                                </asp:DropDownList>
                            </td>
                            <td class="right">
                                <asp:Label runat="server" Text="出貨人：" CssClass="font-style1"></asp:Label>
                            </td>
                            <td class="left">
                                <asp:DropDownList ID="drop_sales_id" runat="server" CssClass="dropdwonlist-size2" DataSourceID="sds_sales_id" DataTextField="account_name" DataValueField="account_id"></asp:DropDownList>
                            </td>
                        </tr>
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="新增">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:ImageButton ID="ibtn_complete" CommandName="Complete" runat="server" ImageUrl="~/Image/return.png" onmouseover="this.src='/Image/return_1.png'" onmouseout="this.src='/Image/return.png'" CommandArgument='<%# Container.DataItemIndex %>' OnClientClick="return(confirm('確認要已出貨嗎？'))"></asp:ImageButton>
                                            </ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="出貨人">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_sales_id" Visible="false" runat="server" Text='<%#Bind("sales_id") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="出貨狀態">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_sales_complete" runat="server" Text='<%#Bind("sales_complete") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="10%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="備註">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_sales_remarks" runat="server" Text='<%#Bind("sales_remarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="10%" />
                                        </asp:TemplateField>
                        ...
                        <EditItemTemplate>
                            <table class="max-width">
                                ...
                                <tr class="max-width">
                                    ...
                                    <td class="right">
                                        <asp:Label runat="server" Text="出貨人："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:DropDownList runat="server" ID="drop_edit_sales_id" Text='<%#Bind("sales_id") %>' CssClass="dropdwonlist-size2" OnDataBinding="drop_sales_id_DataBinding"></asp:DropDownList>
                                    </td>
                                ...
                                <tr class="max-width">
                                    <td class="right">
                                        <asp:Label runat="server" Text="出貨日期："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_edit_sales_datetime" Text='<%#Bind("sales_datetime") %>' CssClass="text-size2 pointer-style1"></asp:TextBox>
                                        <asp:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="text_edit_sales_datetime" Format="yyyy/MM/dd"></asp:CalendarExtender>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="出貨狀態："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_sales_complete" Text='<%#Bind("sales_complete") %>' Enabled="false" CssClass="text-size2"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_edit_sales_remarks" Text='<%#Bind("sales_remarks") %>' TextMode="MultiLine" CssClass="text-no-size text-size2"></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <td colspan="8" class="center">
                                        ...
                                        <asp:Button runat="server" CssClass="blue-style6 button-size2" Text="出貨完畢" CommandName="Complete" OnClientClick="return(confirm('確定出貨完畢嗎？'))" />
                        ...
                        <InsertItemTemplate>
                            <table class="max-width">
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:DropDownList runat="server" ID="drop_insert_sales_id" CssClass="dropdwonlist-size2" OnDataBinding="drop_sales_id_DataBinding"></asp:DropDownList>
                                    </td>
                                </tr>
                                ...
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_insert_sales_datetime" CssClass="text-size2 pointer-style1"></asp:TextBox>
                                        <asp:CalendarExtender ID="CalendarExtender3" runat="server" TargetControlID="text_insert_sales_datetime" Format="yyyy/MM/dd"></asp:CalendarExtender>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_insert_sales_remarks" TextMode="MultiLine" CssClass="text-no-size text-size2"></asp:TextBox>
                                    </td>
                            ...
                            <ContentTemplate>
                                <cc1:GGridView runat="server" EmptyShowHeader="True" FooterInsert="true" EmptyDataText="無顯示資料" OnRowDataBound="grid_data_RowDataBound" OnSelectedIndexChanged="grid_data_SelectedIndexChanged"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="出貨狀態">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lab_sales_complete" Text='<%#Bind("complete_name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:CheckBox ID="ch_sales_complete" runat="server" Checked='<%#Bind("sales_complete") %>' CssClass="check-style1"></asp:CheckBox>
                                            </EditItemTemplate>
                                            <HeaderStyle Width="8%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="出貨數量">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_sales_amount" runat="server" Text='<%#Bind("sales_amount") %>'></asp:Label>
                                                <asp:Label ID="lab_product_unit1" runat="server" Text='<%#Bind("product_unit") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="text_sales_amount" runat="server" Width="90%" OnTextChanged="text_sales_amount_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            </FooterTemplate>
                                            <HeaderStyle Width="8%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="出貨金額">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_sales_money" runat="server" Text='<%#Bind("sales_money") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="text_sales_money" runat="server" Text="點選確認價格" Width="90%" ReadOnly="true"></asp:TextBox>
                                            </FooterTemplate>
                                            <HeaderStyle Width="8%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="備註">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lab_sales_remarks" Text='<%#Bind("sales_remarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="text_sales_remarks" runat="server" Width="90%"></asp:TextBox>
                                            </FooterTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="text_sales_remarks" runat="server" Text='<%#Bind("sales_remarks") %>' Width="90%"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
        ...
        <Triggers>
            ...
            <asp:AsyncPostBackTrigger ControlID="drop_sales_id" EventName="DataBinding" />
        </Triggers>
    </asp:UpdatePanel>
    <asp:SqlDataSource ID="sds_main" OnUpdated="sds_main_Updated" OnInserted="sds_main_Inserted" runat="server" ConnectionString="<%$ ConnectionStrings:MNDT %>" ProviderName="<%$ ConnectionStrings:MNDT.ProviderName %>" UpdateCommand="UPDATE [MNDTsales_master]
...
WHERE [shipments_order] = @original_shipments_order"
        InsertCommand="INSERT INTO [MNDTsales_master]
           ([shipments_order]
           ,[sales_id]
           ,[sales_datetime]
           ,[sales_complete]
...
VALUES
           ...
           ,@sId
           ,GETDATE())"
        DeleteCommand="DELETE FROM [MNDTsales_master]
WHERE [shipments_order] =@original_shipments_order

DELETE FROM [MNDTsales_details]
WHERE [shipments_order] =@original_shipments_order"
        OldValuesParameterFormatString="original_{0}" OnDeleted="sds_main_Deleted">
        <InsertParameters>
            <asp:SessionParameter Name="sId" SessionField="sId" />
            <asp:Parameter Name="sales_id" />
            <asp:Parameter Name="sales_datetime" />
            <asp:Parameter Name="sales_remarks" />
    ...
    <asp:SqlDataSource ID="sds_sales_id" runat="server" SelectCommand="SELECT '' 'account_id', '' 'account_name' UNION SELECT [account_id]       
    ...
    <asp:SqlDataSource ID="sds_detail" runat="server" ConnectionString="<%$ ConnectionStrings:MNDT %>" ProviderName="<%$ ConnectionStrings:MNDT.ProviderName %>" SelectCommand="SELECT [sales_d].[shipments_order]
	  ,[sales_d].[product_kind]
      ,[product_m].[product_kind_name]
	  ,[sales_d].[product_code]
      ,[product_d].[product_code_name]
	  ,[product_d].[product_unit]
      ,[sales_d].[sales_amount]
      ,[sales_d].[sales_money]
      ,[sales_d].[sales_complete]
	  ,CASE [sales_d].[sales_complete] WHEN '1' THEN '已出貨' ELSE '未出貨' END 'complete_name'
      ,[sales_d].[sales_remarks]
FROM [MNDTsales_details] [sales_d] LEFT JOIN [MNDTproduct_master] [product_m]
ON [sales_d].[product_kind] = [product_m].[product_kind] LEFT JOIN [MNDTproduct_details] [product_d]
ON [sales_d].[product_kind] = [product_d].[product_kind]
	AND [sales_d].[product_code] = [product_d].[product_code]
WHERE [shipments_order] = @shipments_order"
        InsertCommand="INSERT INTO [MNDTsales_details]
           ([shipments_order]
           ,[product_kind]
           ,[product_code]
           ,[sales_amount]
...
VALUES
           ...
           ,@sId
           ,GETDATE())"
        OnInserted="sds_detail_Inserted" DeleteCommand="DELETE FROM [MNDTsales_details]
WHERE [shipments_order] =@original_shipments_order
	AND [product_kind] = @original_product_kind
	AND [product_code] = @original_product_code"
        OldValuesParameterFormatString="original_{0}" UpdateCommand="UPDATE [MNDTsales_details]
   SET [sales_complete] = @sales_complete
      ,[sales_remarks] = @sales_remarks
      ,[modify_user_id] = @sId
      ,[modify_datetime] = GETDATE()
WHERE [shipments_order] =@original_shipments_order
	...
	AND [product_code] = @original_product_code"
        ...
        <InsertParameters>
            ...
            <asp:Parameter Name="sales_amount" />
            <asp:Parameter Name="sales_money" />
            <asp:Parameter Name="sales_remarks" />
        </InsertParameters>
        <SelectParameters>
            <asp:Parameter Name="shipments_order" />
        ...
        <UpdateParameters>
            ...
            <asp:Parameter Name="original_product_kind" />
            <asp:Parameter Name="original_product_code" />
            <asp:Parameter Name="sales_complete" />
        </UpdateParameters>
    </asp:SqlDataSource>
