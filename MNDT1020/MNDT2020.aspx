<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" MaintainScrollPositionOnPostback="true" EnableEventValidation="false" Async="true" AutoEventWireup="true" CodeFile="MNDT2020.aspx.cs" Inherits="MNDT2020" %>
...
<asp:Content runat="server" ID="const" ContentPlaceHolderID="ContentPlaceHolder1">
        ...
        <ContentTemplate>
            <asp:MultiView runat="server" ID="multi_view" ActiveViewIndex="0">
                <asp:View runat="server" ID="view_master">
                    <asp:Panel runat="server">
                        <table class="blue-style2 table-size1">
                            ...
                            <tr>
                                <td class="right">
                                    <asp:Label runat="server" Text="廠商代號：" CssClass="font-style1"></asp:Label>
                                </td>
                                <td class="left">
                                    <asp:TextBox ID="text_company_id" runat="server" CssClass="font-style1"></asp:TextBox>
                                </td>


                                <td class="right">
                                    <asp:Label runat="server" Text="廠商名稱：" CssClass="font-style1"></asp:Label>
                                </td>
                                <td class="left">
                                    <asp:TextBox ID="text_company_name" runat="server" CssClass="font-style1"></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <asp:UpdatePanel runat="server">
                            <ContentTemplate>
                                ...
                                <cc1:GGridView runat="server" EmptyShowHeader="True" EmptyDataText="無顯示資料" OnRowDataBound="grid_data_m_RowDataBound" OnRowCommand="grid_data_m_RowCommand"
                                    ...
                                    ID="grid_data_m" DataSourceID="sds_main" DataKeyNames="company_id">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="廠商代號" SortExpression="company_id">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="廠商名稱">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_name" runat="server" Text='<%#Bind("company_name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="廠商地址">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_addr" runat="server" Text='<%#Bind("company_addr") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="廠商電話">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_phone" runat="server" Text='<%#Bind("company_phone") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="聯絡人名稱">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_contact_name" runat="server" Text='<%#Bind("company_contact_name") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>
                                         ...
                                         <asp:TemplateField HeaderText="聯絡人電話">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_contact_phone" runat="server" Text='<%#Bind("company_contact_phone") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="備註">
                                            <ItemTemplate>
                                                <asp:Label ID="lab_company_remarks" runat="server" Text='<%#Bind("company_remarks") %>'></asp:Label>
                                            </ItemTemplate>
                                            <HeaderStyle Width="8.5%" />
                                        </asp:TemplateField>
                ...
                <asp:View runat="server" ID="view_detail">
                    ...
                    <asp:FormView runat="server" ID="fv_master_form" CssClass="max-width" DefaultMode="Edit" DataSourceID="sds_main" DataKeyNames="company_id" OnItemCommand="form_view_master_ItemCommand">
                        <InsertItemTemplate>
                            <table class="max-width">
                                <tr class="max-width">
                                    ...
                                    <td class="right">
                                        <asp:Label runat="server" Text="廠商代碼："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_id" ></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="聯絡人名稱："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_contact_name" ></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    <td class="right" >
                                        <asp:Label runat="server" Text="廠商手機："></asp:Label>
                                    </td>
                                    <td class="left" >
                                        <asp:TextBox runat="server" ID="text_company_phone" ></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="聯絡人電話："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_contact_phone" ></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="right">
                                        <asp:Label runat="server" Text="廠商名稱："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_name" ></asp:TextBox>
                                    </td>
                                    
                                </tr>
                                <tr>
                                    <td class="right">
                                        <asp:Label runat="server" Text="廠商地址："></asp:Label>
                                    </td>
                                    <td class="left" >
                                        <asp:TextBox runat="server" ID="text_company_addr"  Width="100%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_remarks"  Width="100%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <EditItemTemplate>
                            <table class="max-width">
                                <tr class="max-width">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_id" Text='<%#Bind("company_id") %>' ReadOnly="true" CssClass="gray-style2"></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="聯絡人名稱："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_contact_name" Text='<%#Bind("company_contact_name") %>'></asp:TextBox>
                                    </td>
                                    <td colspan="5" rowspan="5" class="right">
                                        <asp:ImageButton ID="imgbtn_next" runat="server" ImageUrl="~/Image/next_one.png" onmouseover="this.src='/Image/next_one_1.png'" onmouseout="this.src='/Image/next_one.png'" OnClick="imgbtn_next_Click" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="left" >
                                        <asp:TextBox runat="server" ID="text_company_phone" Text='<%#Bind("company_phone") %>' TextMode="Phone"></asp:TextBox>
                                    </td>
                                    <td class="right">
                                        <asp:Label runat="server" Text="聯絡人電話："></asp:Label>
                                    </td>
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_contact_phone" Text='<%#Bind("company_contact_phone") %>'></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td class="right">
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_name" Text='<%#Bind("company_name") %>'></asp:TextBox>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="left" >
                                        <asp:TextBox runat="server" ID="text_company_addr" Text='<%#Bind("company_addr") %>' Width="100%"></asp:TextBox>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="left">
                                        <asp:TextBox runat="server" ID="text_company_remarks" Text='<%#Bind("company_remarks") %>' Width="100%" TextMode="MultiLine" CssClass="text-no-size"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="10" class="center">
    ...
    <asp:SqlDataSource ID="sds_main" OnUpdated="sds_main_Updated" runat="server" ConnectionString="<%$ ConnectionStrings:MNDT %>" OldValuesParameterFormatString="original_{0}" ProviderName="<%$ ConnectionStrings:MNDT.ProviderName %>" UpdateCommand="UPDATE [MNDTcompany]
   SET [company_remarks] = @company_remarks
...
WHERE [company_id] = @original_company_id"
        DeleteCommand="DELETE [MNDTcompany] 
WHERE company_id = @original_company_id"
        InsertCommand="INSERT INTO [MNDTcompany]
([company_id]
	,[company_remarks]
	,[company_name]
	,[company_addr]
...
VALUES(@company_id
	...
	,GETDATE())"
        ...
        <DeleteParameters>
            <asp:Parameter Name="original_company_id" />
        </DeleteParameters>
        <InsertParameters>
            <asp:Parameter Name="company_id" />
            <asp:Parameter Name="company_remarks" />
            <asp:Parameter Name="company_name" />
            <asp:Parameter Name="company_addr" />
            <asp:Parameter Name="company_phone" />
            <asp:SessionParameter Name="UserId" SessionField="sId" />
            <asp:Parameter Name="company_contact_name" />
            <asp:Parameter Name="company_contact_phone" />
        </InsertParameters>
        <UpdateParameters>
            <asp:Parameter Name="company_remarks" />
            <asp:Parameter Name="company_name" />
