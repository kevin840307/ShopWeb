<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ReceiveEditView.aspx.cs" Inherits="ReceiveEditView" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="Scripts/Presenter/Admin/Receive/receive-edit-presenter.js"></script>
    <script src="Scripts/View/Admin/Receive/receive-edit-view.js"></script>
    <script type="text/javascript">
        var receiveEditView = {};
        var receiveEditPresenter = {};
        $(function () {

            function fnInitialization() {
                receiveEditView.__proto__ = ReceiveEditView.prototype;
                receiveEditPresenter.__proto__ = ReceiveEditPresenter.prototype;
                ReceiveEditView.call(receiveEditView, receiveEditPresenter);
                ReceiveEditPresenter.call(receiveEditPresenter, receiveEditView);
                receiveEditPresenter.fnInitialization();
            }
    ...
    <div id="content_header_div">
        ...
        <div class="content-header-right">
            <button type="button" class="btn-img-style1" id="btn_last" onclick="receiveEditView.fnLast();" title="上一筆">
                <img src="Image/last.png"></button>
            <button type="button" class="btn-img-style1" id="btn_next" onclick="receiveEditView.fnNext();" title="下一筆">
                <img src="Image/next.png"></button>
            <button type="button" class="btn-img-style1" id="btn_back" onclick="window.location='ReceiveSearchView.aspx'">
                <img src="Image/back.png"></button>
            <button type="button" class="btn-img-style3"  onclick="receiveEditView.fnJumpReturn();" >
        ...
        <div class="col-12">
            <div class="frame-style3">
                <div class="frame-title-div title-h3-style1">
                    <h3>
                        <img src="Image/person.png" /><p>進貨資料編輯</p>
                    </h3>
                </div>
                ...
                <div class="frame-content-div">
                    <div id="tab" class="tab-style1">
                        <ul class="tab-items">
                            <li class='tab-item select' id="tab1" onclick="receiveEditView.fnTitleTabEvent(this);">進貨資訊</li>
                            <li class='tab-item' id="tab2" onclick="receiveEditView.fnTitleTabEvent(this);">材料資訊</li>
                            <li class='tab-item' id="tab3" onclick="receiveEditView.fnTitleTabEvent(this);">歷史資訊</li>
                        </ul>

                        <form class='content-style1 tab-content' id="tab1_content" onsubmit="receiveEditView.fnTab1Update(event);">
                            <div class="general">
                            ...
                            <div class="general">
                                <div class="col-2-left-r">
                                    <label class="font-red">*進貨日期</label>
                                </div>
                                <div class="col-10-right">
                        ...
                        <form class='tab-content hide' id="tab2_content">
                            <div class="frame-style2">
                                <div class="frame-title-div">
                                    ...
                                    <div class="right-div">
                                        <div class="action">
                                            <button type="button" class="btn-img-style1" id="details_refresh" onclick="receiveEditPresenter.fnInitializationTab2()">
                                                <img src="Image/refresh.png"></button>

                                            <button type='button' class='btn-img-style1' onclick='receiveEditView.fnTab2AppendInsert();'>
                                                <img src='Image/insert.png' /></button>

                                            <button type='button' class='btn-img-style3' onclick='receiveEditView.fnTab2Inserts();'>
                                                <img src='Image/tick.png' /></button>

                                            <button type='button' class='btn-img-style4' onclick='receiveEditView.fnTab2Verifications();'>
                                                <img src='Image/verification.png' /></button>
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" onchange="receiveEditView.fnTab2MaxPageSizeChange(this);">
                                        ...
                                        <table id="list" class="list-table">
                                            <thead>
                                                <tr>
                                                    <td class='general'>已進貨</td>
                                                    <td class='general'>已付款</td>
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" onchange="receiveEditView.fnTab3MaxPageSizeChange(this);">
                                                    <option value="8">8</option>
                                                    <option value="10">10</option>
                                                    <option value="20">20</option>
                                                    <option value="50">50</option>
