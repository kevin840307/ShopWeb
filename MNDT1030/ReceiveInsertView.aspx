<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ReceiveInsertView.aspx.cs" Inherits="ReceiveInsertView" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="Scripts/View/Admin/Receive/receive-insert-view.js"></script>
    <script src="Scripts/Presenter/Admin/Receive/receive-insert-presenter.js"></script>
    <script type="text/javascript">
        var receiveInsertView = {};
        $(function () {

            function fnInitialization() {
                var receiveInsertPresenter = {};
                receiveInsertView.__proto__ = ReceiveInsertView.prototype;
                receiveInsertPresenter.__proto__ = ReceiveInsertPresenter.prototype;
                ReceiveInsertView.call(receiveInsertView, receiveInsertPresenter);
                ReceiveInsertPresenter.call(receiveInsertPresenter, receiveInsertView);
                receiveInsertPresenter.fnInitialization();
            }
        ...
        <div class="col-12">
            <div class="frame-style3">
                <div class="frame-title-div title-h3-style1">
                    <h3>
                        <img src="Image/person.png" /><p>進貨資料新增</p>
                    </h3>
                </div>
                ...
                <div class="frame-content-div">
                    <div id="tab" class="tab-style1">
                        <ul class="tab-items">
                            <%--prohibited--%>
                            <li class='tab-item select' id="tab1" onclick="receiveInsertView.fnTitleTabEvent(this);">進貨資訊</li>
                            <li class='tab-item prohibited' id="tab2" onclick="receiveInsertView.fnTitleTabEvent(this);">材料資訊</li>
                        </ul>
                        <form class='tab-content content-style1' id="tab1_content" onsubmit="receiveInsertView.fnTab1Insert(event);">
                            <div class="general">
                        ...
                        <form class='tab-content content-style1 hide' id="tab2_content" onsubmit="receiveInsertView.fnTab2Inserts(event);">
                            <div class="frame-style2">
                                <div class="frame-title-div">
                                    <div class="left-div">
                                        <h3 class="title-h3-style1">
                                            <img src="Image/person.png" />進貨資訊
                                        </h3>
                                    </div>
                                    <div class="right-div">
                                        <div class="action">
                                            <button type='button' class='btn-img-style1' onclick='receiveInsertView.fnTab2AppendInsert();'>
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" id="select_page_size" onchange="receiveInsertView.fnMaxPageSizeChange(this);">
