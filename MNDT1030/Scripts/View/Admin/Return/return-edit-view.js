...
function ReturnEditView(returnEditPresenter) {
    this.g_returnEditPresenter = returnEditPresenter;
    this.g_sTabID = "#tab";
    this.g_sTitleTabSelectID = '#tab1';
    this.g_arrayHtml = [];
}

ReturnEditView.prototype = {
    TAG: 'ReturnEditView',
    ...
    fnTabChangeEvent: function (type) {
        switch (type) {
            case 'tab1':
                //this.g_returnEditPresenter.fnInitializationTab1();
                break;
            case 'tab2':
                if (this.g_bTab2FirstInit) {
                    this.g_returnEditPresenter.fnInitializationTab2();
                    this.g_bTab2FirstInit = false;
                }
                break;
            case 'tab3':
                if (this.g_bTab3FirstInit) {
                    this.g_returnEditPresenter.fnInitializationTab3();
    ...
    fnLast: function () {
        this.g_returnEditPresenter.fnSelectReturnId(-1);
    },
    ...
    fnSetTab1View: function (jsonValue) {
        ...
        if (this.g_returnEditPresenter.g_bComplete) {
    ...
    fnTab1Update: function (event) {
        ...
        this.g_returnEditPresenter.fnTab1Update(update);
    },
    ...
    fnTab2ChangeUrl: function (arg) {
        ...
        setTimeout(function () {
            that.g_returnEditPresenter.fnInitializationTab2();
        }, 300);
    },
    ...
    fnPushTab2Columns: function (jsonValue) {
        this.g_arrayHtml.push("   <tr ondblclick='returnEditView.fnChangeEdit(this);'> ");
        ...
        this.g_arrayHtml.push("              <button type='button' class='btn-img-style1'><img src='Image/edit.png' onclick='returnEditView.fnChildChangeEdit(this);' /></button> ");
        this.g_arrayHtml.push("              <button type='button' class='btn-img-style2'><img src='Image/delete.png' onclick='returnEditView.fnTab2Detele(\"" + jsonValue.seq + "\");' /></button> ");
        this.g_arrayHtml.push("          </div> ");
        this.g_arrayHtml.push("      </td> ");
    ...
    fnPushTab2PageNumber: function (name, page, select) {
        this.g_arrayHtml.push("  <li><a class='" + select + "' onclick='returnEditView.fnTab2PageNumberChange(\"" + page + "\")' >" + name + "</a></li> ");
    },
    ...
    fnTab2MaxPageSizeChange: function (item) {
        this.g_returnEditPresenter.fnTab2MaxPageSizeChange(item.value);
    },

    fnTab2PageNumberChange: function (value) {
        this.g_returnEditPresenter.fnTab2PageNumberChange(value);
    },
    ...
    fnTab2AppendInsert: function () {
        if (!this.g_returnEditPresenter.g_bComplete) {
            ...
            this.g_arrayHtml.push("      <td> ");
            this.g_arrayHtml.push("          <input type='text' maxlength='5' placeholder='材料' list='material_list' name='material_id' required='required' oninput='returnEditView.fnTab2SelectInsertPrice(this);' class='input-data-required' />");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            ...
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            this.g_arrayHtml.push("          <input type='text' maxlength='10' placeholder='數量' pattern='[0-9]{1,7}[.]{0,1}[0-9]{0,1}' name='amount' required='required' class='input-data-required' oninput='returnEditView.fnTab2SelectInsertPrice(this);'  />");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            ...
            this.g_arrayHtml.push("      <td class='action'> ");
            this.g_arrayHtml.push("          <div> ");
            this.g_arrayHtml.push("               <button type='button' class='btn-img-style3' onclick='returnEditView.fnTab2Insert(this);'><img src='Image/tick.png' /></button> ");
            this.g_arrayHtml.push("               <button type='button' class='btn-img-style2' onclick='returnEditView.fnTab2RemoveInsert(this);'><img src='Image/cancel.png' /></button> ");
            this.g_arrayHtml.push("          </div> ");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("   </tr> ");
    ...
    fnPushEditColumn: function (tr, data) {
        ...
        this.g_arrayHtml.push("      </td> ");
        this.g_arrayHtml.push("      <td> ");
        this.g_arrayHtml.push("          <input type='text' maxlength='10' placeholder='數量' pattern='[0-9]{1,7}[.]{0,1}[0-9]{0,1}' name='amount' class='input-data-required' required='required' oninput='returnEditView.fnTab2SelectEditPrice(this);' value='" + data.amount + "'  />");
        this.g_arrayHtml.push("      </td> ");
        this.g_arrayHtml.push("      <td> ");
        ...
        this.g_arrayHtml.push("      <td class='action'> ");
        this.g_arrayHtml.push("          <div> ");
        this.g_arrayHtml.push("               <button type='button' class='btn-img-style4' onclick='returnEditView.fnTab2Update(this);'><img src='Image/save.png' /></button> ");
        this.g_arrayHtml.push("               <button type='button' class='btn-img-style2' onclick='returnEditView.fnCloseEdit(this, " + JSON.stringify(data) + ");'><img src='Image/cancel.png' /></button> ");
        this.g_arrayHtml.push("          </div> ");
        this.g_arrayHtml.push("      </td> ");
    ...
    fnTab2Insert: function (item) {
        ...
        var insert = {
            method: "fnInsertD",
            return_id: this.g_returnEditPresenter.g_sReturnId,
        ...
        this.g_returnEditPresenter.fnTab2Insert(tr, insert);
    },
    ...
    fnTab2Inserts: function () {
        ...
        this.g_returnEditPresenter.fnTab2Inserts(inserts);
    },
    ...
    fnTab2Update: function (item) {
        ...
        this.g_returnEditPresenter.fnTab2Update(tr, update);
    },
    ...
    fnTab2Verifications: function () {
        if (!this.g_returnEditPresenter.g_bComplete) {
            ...
            this.g_returnEditPresenter.fnTab2Verifications(updates);
        } else {
    ...
    fnTab2Detele: function (seq) {
        if (!this.g_returnEditPresenter.g_bComplete) {
            if (confirm("確定要刪除嗎!")) {
                ...
                this.g_returnEditPresenter.fnTab2Delete(arg);
            }
        } else {
    ...
    fnTab2SelectInsertPrice: function (ID) {
        ...
        this.g_returnEditPresenter.fnTab2SelectPrice(tr, select);
    },
    ...
    fnChangeReadOnly: function (tr, jsonValue) {
        ...
        tr.html(this.g_arrayHtml.join(''));
        tr.attr('name', '');
        tr.attr('ondblclick', 'returnEditView.fnChangeEdit(this);');
        this.g_arrayHtml = [];
    },
    ...
    fnTab3ChangeUrl: function (arg) {
        ...
        window.history.pushState('', 'uselessTitle', arg);
        setTimeout(function () {
            that.g_returnEditPresenter.fnInitializationTab3();
        }, 300);
    },
    ...
    fnPushTranPageNumber: function (name, page, select) {
        this.g_arrayHtml.push("  <li><a class='" + select + "' onclick='returnEditView.fnTab3PageNumberChange(\"" + page + "\")' >" + name + "</a></li> ");
    },
    ...
    fnTab3MaxPageSizeChange: function (item) {
        this.g_returnEditPresenter.fnTab3MaxPageSizeChange(item.value);
    },

    fnTab3PageNumberChange: function (value) {
        this.g_returnEditPresenter.fnTab3PageNumberChange(value);
    },
