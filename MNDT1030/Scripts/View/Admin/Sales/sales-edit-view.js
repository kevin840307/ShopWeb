...
function SalesEditView(salesEditPresenter) {
    this.g_salesEditPresenter = salesEditPresenter;
    this.g_sTabID = "#tab";
    this.g_sTitleTabSelectID = '#tab1';
    this.g_arrayHtml = [];
}

SalesEditView.prototype = {
    TAG: 'SalesEditView',
    ...
    fnJumpReturn: function () {
        if (confirm("確定要到退貨單嗎?")) {
            var arg = {
                "method": "fnJumpReturn"
                , "order_id": this.g_salesEditPresenter.g_sOrderId
            };
            this.g_salesEditPresenter.fnJumpReturn(arg);
        }
    },
    ...
    fnTabChangeEvent: function (type) {
        switch (type) {
            case 'tab1':
                //this.g_salesEditPresenter.fnInitializationTab1();
                break;
            case 'tab2':
                if (this.g_bTab2FirstInit) {
                    this.g_salesEditPresenter.fnInitializationTab2();
                    this.g_bTab2FirstInit = false;
                }
                break;
            case 'tab3':
                if (this.g_bTab3FirstInit) {
                    this.g_salesEditPresenter.fnInitializationTab3();
    ...
    fnLast: function () {
        this.g_salesEditPresenter.fnSelectOrderId(-1);
    },
    ...
    fnSetTab1View: function (jsonValue) {
        ...
        $(this.g_sTab1PayID).val(jsonValue.pay);
        $(this.g_sTab1OrderStatusID).val(jsonValue.order_status);
        ...
        if (this.g_salesEditPresenter.g_bComplete) {
            ...
            $(this.g_sTab1PayID).prop("readonly", "readonly");
            $(this.g_sTab1OrderStatusID).prop("readonly", "readonly");
            ...
            $(this.g_sTab1PayID).addClass('readonly');
            $(this.g_sTab1OrderStatusID).addClass('readonly');
        }
    ...
    fnTab1Update: function (event) {
        ...
        this.g_salesEditPresenter.fnTab1Update(update);
    },
    ...
    fnTab2ChangeUrl: function (arg) {
        ...
        setTimeout(function () {
            that.g_salesEditPresenter.fnInitializationTab2();
        }, 300);
    },
    ...
    fnPushTab2Columns: function (jsonValue) {
        this.g_arrayHtml.push("   <tr ondblclick='salesEditView.fnChangeEdit(this);'> ");
        ...
        this.g_arrayHtml.push("              <button type='button' class='btn-img-style1'><img src='Image/edit.png' onclick='salesEditView.fnChildChangeEdit(this);' /></button> ");
        this.g_arrayHtml.push("              <button type='button' class='btn-img-style2'><img src='Image/delete.png' onclick='salesEditView.fnTab2Detele(\"" + jsonValue.seq + "\");' /></button> ");
        this.g_arrayHtml.push("              <button type='button' class='btn-img-style3'><img src='Image/change.png' onclick='salesEditView.fnTab2Change(\"" + jsonValue.seq + "\");' /></button> ");
        this.g_arrayHtml.push("          </div> ");
    ...
    fnPushTab2PageNumber: function (name, page, select) {
        this.g_arrayHtml.push("  <li><a class='" + select + "' onclick='salesEditView.fnTab2PageNumberChange(\"" + page + "\")' >" + name + "</a></li> ");
    },
    ...
    fnTab2MaxPageSizeChange: function (item) {
        this.g_salesEditPresenter.fnTab2MaxPageSizeChange(item.value);
    },

    fnTab2PageNumberChange: function (value) {
        this.g_salesEditPresenter.fnTab2PageNumberChange(value);
    },
    ...
    fnTab2AppendInsert: function () {
        if (!this.g_salesEditPresenter.g_bComplete) {
            ...
            this.g_arrayHtml.push("      <td> ");
            this.g_arrayHtml.push("          <input type='text' maxlength='13' placeholder='產品' list='product_list' name='product_id' required='required' oninput='salesEditView.fnTab2SelectInsertPrice(this);' class='input-data-required' />");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            ...
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            this.g_arrayHtml.push("          <input type='text' maxlength='15' placeholder='數量' pattern='[0-9]{1,7}[.]{0,1}[0-9]{0,1}' name='amount' required='required' class='input-data-required' oninput='salesEditView.fnTab2SelectInsertPrice(this);'  />");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("      <td> ");
            ...
            this.g_arrayHtml.push("      <td class='action'> ");
            this.g_arrayHtml.push("          <div> ");
            this.g_arrayHtml.push("               <button type='button' class='btn-img-style3' onclick='salesEditView.fnTab2Insert(this);'><img src='Image/tick.png' /></button> ");
            this.g_arrayHtml.push("               <button type='button' class='btn-img-style2' onclick='salesEditView.fnTab2RemoveInsert(this);'><img src='Image/cancel.png' /></button> ");
            this.g_arrayHtml.push("          </div> ");
            this.g_arrayHtml.push("      </td> ");
            this.g_arrayHtml.push("   </tr> ");
    ...
    fnPushEditColumn: function (tr, data) {
        ...
        this.g_arrayHtml.push("      </td> ");
        this.g_arrayHtml.push("      <td> ");
        this.g_arrayHtml.push("          <input type='text' maxlength='10' placeholder='數量' pattern='[0-9]{1,7}[.]{0,1}[0-9]{0,1}' name='amount' class='input-data-required' required='required' oninput='salesEditView.fnTab2SelectEditPrice(this);' value='" + data.amount + "'  />");
        this.g_arrayHtml.push("      </td> ");
        this.g_arrayHtml.push("      <td> ");
        ...
        this.g_arrayHtml.push("      <td class='action'> ");
        this.g_arrayHtml.push("          <div> ");
        this.g_arrayHtml.push("               <button type='button' class='btn-img-style4' onclick='salesEditView.fnTab2Update(this);'><img src='Image/save.png' /></button> ");
        this.g_arrayHtml.push("               <button type='button' class='btn-img-style2' onclick='salesEditView.fnCloseEdit(this, " + JSON.stringify(data) + ");'><img src='Image/cancel.png' /></button> ");
        this.g_arrayHtml.push("          </div> ");
        this.g_arrayHtml.push("      </td> ");
    ...
    fnChangeReadOnly: function (tr, jsonValue) {
        ...
        tr.html(this.g_arrayHtml.join(''));
        tr.attr('name', '');
        tr.attr('ondblclick', 'salesEditView.fnChangeEdit(this);');
        this.g_arrayHtml = [];
    },
    ...
    fnTab2Insert: function (item) {
        ...
        this.g_salesEditPresenter.fnTab2Insert(tr, insert);
    },
    ...
    fnTab2Inserts: function () {
        ...
        this.g_salesEditPresenter.fnTab2Inserts(inserts);
    },
    ...
    fnTab2Update: function (item) {
        ...
        this.g_salesEditPresenter.fnTab2Update(tr, update);
    },
    ...
    fnTab2Updates: function (item) {
        ...
        this.g_salesEditPresenter.fnTab2Updates(updates);
    },
    ...
    fnTab2Detele: function (seq) {
        if (!this.g_salesEditPresenter.g_bComplete) {
            if (confirm("確定要刪除嗎!")) {
                ...
                this.g_salesEditPresenter.fnTab2Delete(arg);
            }
        } else {
    ...
    fnTab2Change: function (seq) {
        if (confirm("確定要退貨嗎!")) {
            ...
            this.g_salesEditPresenter.fnTab2Change(arg);
        }
    },
    ...
    fnTab2SelectInsertPrice: function (ID) {
        ...
        this.g_salesEditPresenter.fnTab2SelectPrice(tr, select);
    },
    ...
    fnTab3ChangeUrl: function (arg) {
        ...
        window.history.pushState('', 'uselessTitle', arg);
        setTimeout(function () {
            that.g_salesEditPresenter.fnInitializationTab3();
        }, 300);
    },
    ...
    fnPushTranPageNumber: function (name, page, select) {
        this.g_arrayHtml.push("  <li><a class='" + select + "' onclick='salesEditView.fnTab3PageNumberChange(\"" + page + "\")' >" + name + "</a></li> ");
    },
    ...
    fnTab3MaxPageSizeChange: function (item) {
        this.g_salesEditPresenter.fnTab3MaxPageSizeChange(item.value);
    },

    fnTab3PageNumberChange: function (value) {
        this.g_salesEditPresenter.fnTab3PageNumberChange(value);
    },
