...
function MaterialInsertView(materialInsertPresenter) {
    this.g_materialInsertPresenter = materialInsertPresenter;
    this.g_sMaterialID = '#text_material_id';
...
MaterialInsertView.prototype = {
    TAG: 'MaterialInsertView',
    ...
    fnInsert: function (event) {
        ...
        var insert = {
            method: "fnInsert",
            material_id: $(this.g_sMaterialID).val(),
        ...
        this.g_materialInsertPresenter.fnInsert(insert);
    },
