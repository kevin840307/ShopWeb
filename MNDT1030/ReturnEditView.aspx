<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="ReturnEditView.aspx.cs" Inherits="ReturnEditView" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="Scripts/Presenter/Admin/Return/return-edit-presenter.js"></script>
    <script src="Scripts/View/Admin/Return/return-edit-view.js"></script>
    <script type="text/javascript">
        var returnEditView = {};
        var returnEditPresenter = {};
        $(function () {

            function fnInitialization() {
                returnEditView.__proto__ = ReturnEditView.prototype;
                returnEditPresenter.__proto__ = ReturnEditPresenter.prototype;
                ReturnEditView.call(returnEditView, returnEditPresenter);
                ReturnEditPresenter.call(returnEditPresenter, returnEditView);
                returnEditPresenter.fnInitialization();
            }
    ...
    <div id="content_header_div">
        ...
        <div class="content-header-right">
            <button type="button" class="btn-img-style1" id="btn_last" onclick="returnEditView.fnLast();" title="上一筆">
                <img src="Image/last.png"></button>
            <button type="button" class="btn-img-style1" id="btn_next" onclick="returnEditView.fnNext();" title="下一筆">
        ...
        <div class="col-12">
            <div class="frame-style3">
                <div class="frame-title-div title-h3-style1">
                    <h3>
                        <img src="Image/person.png" /><p>進退貨資料編輯</p>
                    </h3>
                </div>
                ...
                <div class="frame-content-div">
                    <div id="tab" class="tab-style1">
                        <ul class="tab-items">
                            <li class='tab-item select' id="tab1" onclick="returnEditView.fnTitleTabEvent(this);">退貨資訊</li>
                            <li class='tab-item' id="tab2" onclick="returnEditView.fnTitleTabEvent(this);">材料資訊</li>
                            <li class='tab-item' id="tab3" onclick="returnEditView.fnTitleTabEvent(this);">歷史資訊</li>
                        </ul>

                        <form class='content-style1 tab-content' id="tab1_content" onsubmit="returnEditView.fnTab1Update(event);">
                            <div class="general">
                             ...
                             <div class="general">
                                ...
                                <div class="col-10-right">
                                     <label id="lab_order_id">進貨單號</label>
                                    <%--<input type="text" id="text_order_id" list="order_list" maxlength="9" pattern="[0-9]" required="required" placeholder="進貨單號" class="input-data-required" />--%>
                                </div>
                        ...
                        <form class='tab-content hide' id="tab2_content">
                            <div class="frame-style2">
                                <div class="frame-title-div">
                                    ...
                                    <div class="right-div">
                                        <div class="action">
                                            <button type="button" class="btn-img-style1" id="details_refresh" onclick="returnEditPresenter.fnInitializationTab2()">
                                                <img src="Image/refresh.png"></button>

                                            <button type='button' class='btn-img-style1' onclick='returnEditView.fnTab2AppendInsert();'>
                                                <img src='Image/insert.png' /></button>

                                            <button type='button' class='btn-img-style3' onclick='returnEditView.fnTab2Inserts();'>
                                                <img src='Image/tick.png' /></button>

                                            <button type='button' class='btn-img-style4' onclick='returnEditView.fnTab2Verifications();'>
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" onchange="returnEditView.fnTab2MaxPageSizeChange(this);">
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" onchange="returnEditView.fnTab3MaxPageSizeChange(this);">
                                                    <option value="8">8</option>
                                                    <option value="10">10</option>
                                                    <option value="20">20</option>
                                                    <option value="50">50</option>
