<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master" CodeFile="SReturnInsertView.aspx.cs" Inherits="SReturnInsertView" %>
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script src="Scripts/View/Admin/SReturn/sreturn-insert-view.js"></script>
    <script src="Scripts/Presenter/Admin/SReturn/sreturn-insert-presenter.js"></script>
    <script type="text/javascript">
        var sreturnInsertView = {};
        $(function () {

            function fnInitialization() {
                var sreturnInsertPresenter = {};
                sreturnInsertView.__proto__ = SReturnInsertView.prototype;
                sreturnInsertPresenter.__proto__ = SReturnInsertPresenter.prototype;
                SReturnInsertView.call(sreturnInsertView, sreturnInsertPresenter);
                SReturnInsertPresenter.call(sreturnInsertPresenter, sreturnInsertView);
                sreturnInsertPresenter.fnInitialization();
            }
    ...
    <div id="content_header_div">
        ...
        <ul>
            ...
            <li>
                <a href="AccountSearchView.aspx?page=1">銷退貨資料維護</a>
            </li>
        </ul>
        ...
        <div class="col-12">
            <div class="frame-style3">
                <div class="frame-title-div title-h3-style1">
                    <h3>
                        <img src="Image/person.png" /><p>銷退貨資料新增</p>
                    </h3>
                </div>
                ...
                <div class="frame-content-div">
                    <div id="tab" class="tab-style1">
                        <ul class="tab-items">
                            <%--prohibited--%>
                            <li class='tab-item select' id="tab1" onclick="sreturnInsertView.fnTitleTabEvent(this);">退貨資訊</li>
                            <li class='tab-item prohibited' id="tab2" onclick="sreturnInsertView.fnTitleTabEvent(this);">產品資訊</li>
                        </ul>
                        <form class='tab-content content-style1' id="tab1_content" onsubmit="sreturnInsertView.fnTab1Insert(event);">
                            <div class="general">
                            ...
                            <div class="general">
                                ...
                                <div class="col-10-right">
                                    <input type="text" id="text_order_id" list="order_list" maxlength="13" pattern="?[0-9]{12}" required="required" placeholder="銷貨單號" class="input-data-required" />
                                </div>
                            </div>
                            <div class="general">
                                <div class="col-2-left-r">
                        ...
                        <form class='tab-content content-style1 hide' id="tab2_content" onsubmit="sreturnInsertView.fnTab2Inserts(event);">
                            <div class="frame-style2">
                                <div class="frame-title-div">
                                    ...
                                    <div class="right-div">
                                        <div class="action">
                                            <button type='button' class='btn-img-style1' onclick='sreturnInsertView.fnTab2AppendInsert();'>
                                ...
                                <div class="frame-content-div">
                                    <div class="list-style1">
                                        <div class="list-data-div">
                                            <div>
                                                顯示筆數：
                                                <select class="drop-style1" id="select_page_size" onchange="sreturnInsertView.fnMaxPageSizeChange(this);">
